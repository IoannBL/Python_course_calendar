...
class Main_page(ft.Container):
    def __init__(self,page: ft.Page):
        super().__init__()
        self._notification = Main_page.view_notifications()
    ...
    def show_notify():
        ...
        notifications = Main_page.view_notifications()
        for i in notifications:
            notify.controls.append(
                ft.Container(
                    padding=10,
                    width=175,
                    bgcolor='#55cc3333',
                    ...
                    content=ft.Column(
                        ...
                        controls=[
                            ft.Container(
                                ...
                                content=ft.Icon(name=ft.icons.CIRCLE_NOTIFICATIONS_OUTLINED, color=ft.colors.BLUE_800)
                            ),
    ...
    def animate_container(self,e):
        if self.notify.visible == True:
            self.notify.visible = False
        elif self.notify.visible == False:
